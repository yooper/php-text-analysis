...
{    
    ...
    /**
     * Initializes internal list of stop words 
     */
    ...
    /**
     * Set the list of stop words, the stop word list gets sorted right after being passed into 
     * this function
    ...
    public function setStopWords(array $stopWords)
    {
        ...
        $result = sort($this->stopWords);
        if(!$result) { 
            throw new \InvalidArgumentException("Could not sort stop word array");
        }
    }
